...
from amdlbot import loop
from amdlbot.helpers.functions import isAdmin
...
def run_sync_in_thread(func: Callable) -> Callable:
    ...
    see example at :- https://github.com/sanjit-sinha/amdlbot-Boilerplate/blob/43ce589fbf7fbfcba6347d0e1945ac7299667e80/amdlbot/plugins/sudo/speedtest.py#L13
    """
