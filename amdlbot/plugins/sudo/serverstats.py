...
from amdlbot import bot, BotStartTime
from amdlbot.helpers.functions import get_readable_bytes, get_readable_time


@bot.on_message(filters.command(["stats", "serverstats"]))
async def stats(_, message: Message):

    image = Image.open("amdlbot/helpers/assets/statsbg.png").convert("RGB")
    IronFont = ImageFont.truetype("amdlbot/helpers/assets/IronFont.otf", 42)
